...
//	public boolean checkNetWorkAfterDo(Activity activity, DialogInterface.OnClickListener l) {
//		if( !isConnected() ) {
//			String msg = activity.getString(R.string.qindangqianwuwangluolianjieqingjiancha);
//			CustomDialog.showBuilderOne(activity, activity.getString(R.string.wangluoyichang), msg);
//			return false;
//		}
//		if( !isWifi() && !mIsAgree ) {
//			String msg = activity.getString(R.string.fasongxinxihuichanshengliuliang);
//			CustomDialog.showBuilderOne(activity, activity.getString(R.string.tishi), msg, activity.getString(R.string.jixu), l);
//			return false;
//		}
//		return true;
//	}
	...
	private class ConnectivityBroadcastReceiver extends BroadcastReceiver {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if( !action.equals(ConnectivityManager.CONNECTIVITY_ACTION) || mListening == false ) {
				DebugUtil.w(TAG, "onReceived() called with " + mState.toString() + " and " + intent);
				return;
			}
			...
			DebugUtil.d(TAG, "onReceive(): mNetworkInfo=" + mNetworkInfo + " mOtherNetworkInfo = "
